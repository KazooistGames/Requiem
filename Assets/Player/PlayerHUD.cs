...
public class PlayerHUD : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Player.INSTANCE ? Player.INSTANCE.HostEntity : false)
        {
            ...
            statBarTransforms[3].GetComponent<Image>().color = (int)Player.INSTANCE.HostEntity.Posture > -1 ? (Player.INSTANCE.HostEntity.Posture == Character.PostureStrength.Strong ? new Color(1, 0, 0, 1.0f) : new Color(1, 0, 0, 0.5f)) : new Color(1, 0, 0.75f, 0.5f);
