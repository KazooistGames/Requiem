...
public class Game_Arena : Game
{
    ...
    private void configureSpawners()
    {
        ...
        MobSpawner.OnSpawned = (listOfNewInstances) =>
        {
            ...
            {
                Entity entity = mob.GetComponent<Entity>();
    ...
    private IEnumerator foeQuest(Stage stage, Type entityType)
    {
        ...
        void increment(Entity triggeringEntity)
        {
        ...
        Entity.EntityVanquished.AddListener(increment);
        ...
        Entity.EntityVanquished.RemoveListener(increment);
        yield break;
    }
}
